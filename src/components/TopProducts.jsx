...
const ProductsData = [
  {
    ...
    title: "Casual Dress",
    description:
      "Stay effortlessly stylish with our comfy and chic casual dresses – perfect for everyday wear.",
  },
  {
    id: 2,
    img: Img2,
    title: "Printed Shirt",
    description:
      "Add personality to your look with bold and trendy printed shirts made to stand out.",
  },
  {
    id: 3,
    img: Img3,
